#' Independence-based identification and evaluation based on distance covariances
#'
...
#' @export simulate.dcov
#'
#' @examples NULL
simulate.dcov <- function(Data, AOA, Reorder = TRUE, Bmat, Subsample = NULL, Plot = FALSE, Varname = c("x", "pi", "r")){
